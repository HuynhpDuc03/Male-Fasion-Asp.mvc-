...
namespace MaleFashion.Areas.PrivatePages.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,GiaBan,GiamGia,MoTa,HinhSP,MaTL,NgayCapNhat,MaNCC,BanChay,Duyet,PhoBien,LuotXem")] SanPham sp, HttpPostedFileBase file)
        {
